                ...
                >
                    ...
                    <div className='mt-1.5 flex items-center justify-end gap-1.5'>
                        <button
                            ...
                            className='px-3 py-1.55 text-xs text-neutral-400 transition-colors hover:text-neutral-50'
                        >
                            Close
                        </button>
                        <button
                            type='submit'
                            className='flex items-center gap-1.5 rounded bg-neutral-50 px-3 py-1.55
